import { search, changeDelflag,getlist,getselect, add, update, getspecies } from '../services/species';
...
export default {
  ...
  effects: {
    ...
    *changespecies({ payload }, { call, put }) {
      yield put(routerRedux.push('/productm/SpeciesModel?id=' + payload.data.key)
      )
    },
    *getspecies({ payload }, { call, put }) {
      const response = yield call(getspecies, payload);
      yield put({
    ...
    *add({ payload }, { call, put }) {
      ...
      yield call(messagePut, { response, put });
      if (response.Success) {
        yield put(routerRedux.push('/productm/species'));
      }
    },
