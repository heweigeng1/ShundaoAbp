import { search, changeDelflag, add, update,getlist,WXLogin,wxCode } from '../services/user';
  ...
  effects: {
    ...
    *wxlogin({ payload }, { call, put }) {
      ...
      if (response.Success === true) {
        yield put(routerRedux.push("/user/success"));
      }else{
        yield put(routerRedux.push("/user/fail"));
      }
    },
    *wxCode({ payload }, { call, put }) {
      const response = yield call(wxCode, payload);
      if (response.Success === true) {
        yield put(routerRedux.push("/user/success"));
      }else{
        yield put(routerRedux.push("/user/fail"));
